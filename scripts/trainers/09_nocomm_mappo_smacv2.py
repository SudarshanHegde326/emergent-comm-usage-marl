"""SMACv2 - no communication (control condition).

This file contains NO training logic. It fixes --comm=none and delegates to
...
--no-comm-to-memory.
    ...
    python scripts/trainers/09_nocomm_mappo_smacv2.py --mode standard --seed 0
    python scripts/trainers/09_nocomm_mappo_smacv2.py --mode epo      --seed 0
"""
