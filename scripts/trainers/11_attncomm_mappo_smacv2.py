"""SMACv2 - multi-head scaled dot-product attention.

This file contains NO training logic. It fixes --comm=attn and delegates to
...
--no-comm-to-memory.
    ...
    python scripts/trainers/11_attncomm_mappo_smacv2.py --mode standard --seed 0
    python scripts/trainers/11_attncomm_mappo_smacv2.py --mode epo      --seed 0
"""
