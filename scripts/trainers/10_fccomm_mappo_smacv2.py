"""SMACv2 - fully-connected broadcast (mean of all living peers).

This file contains NO training logic. It fixes --comm=fc and delegates to
...
--no-comm-to-memory.
    ...
    python scripts/trainers/10_fccomm_mappo_smacv2.py --mode standard --seed 0
    python scripts/trainers/10_fccomm_mappo_smacv2.py --mode epo      --seed 0
"""
