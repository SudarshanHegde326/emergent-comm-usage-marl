...
add_if_exists experiments/sl_none/aggregate.json   "No comm"
add_if_exists experiments/sl_fc/aggregate.json     "FC comm"
add_if_exists experiments/sl_attn/aggregate.json   "Attention comm"
