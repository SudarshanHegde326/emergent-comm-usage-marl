...
add_if_exists 0.10 artifacts/checkpoints/attncomm_noise_s010/aggregate.json
add_if_exists 0.25 artifacts/checkpoints/attncomm_noise_s025/aggregate.json
add_if_exists 0.50 artifacts/checkpoints/attncomm_noise_s050/aggregate.json

BASE_ATTN="artifacts/checkpoints/attncomm_official/aggregate.json"
if [ ! -f "$BASE_ATTN" ]; then
