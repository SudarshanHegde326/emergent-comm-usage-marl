...
def main():
    ...
    # FIX 1: Changed 'args.noise-aggregates' to 'args.noise_aggregates' to fix the subtraction bug
    ...
    # Plot sensitivity line with shaded standard deviation area
    xs = np.array(xs)
    ys = np.array(ys)
    ...
    # Overlay raw seed scatter points with a slight jitter for clarity
