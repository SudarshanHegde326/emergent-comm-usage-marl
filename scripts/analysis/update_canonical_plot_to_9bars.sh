...
add_if_exists artifacts/checkpoints/nocomm_mappo/aggregate.json                 "No comm"
add_if_exists artifacts/checkpoints/fccomm_mappo/aggregate.json                 "FC comm"
add_if_exists artifacts/checkpoints/attncomm_mappo/aggregate.json               "Attention"
add_if_exists artifacts/checkpoints/attncomm_bw8/aggregate.json                 "Attn + bw=8"
add_if_exists artifacts/checkpoints/attncomm_ib_b0p01/aggregate.json            "Attn + IB β=0.01"
add_if_exists artifacts/checkpoints/attncomm_noise_s010/aggregate.json          "Attn + σ=0.10"
add_if_exists artifacts/checkpoints/attncomm_noise_s025/aggregate.json          "Attn + σ=0.25"
add_if_exists artifacts/checkpoints/attncomm_noise_s050/aggregate.json          "Attn + σ=0.50"
add_if_exists artifacts/checkpoints/gnncomm_mappo/aggregate.json                "GNN-comm"
