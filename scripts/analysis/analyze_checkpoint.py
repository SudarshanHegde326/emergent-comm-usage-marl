...
-----
    python analyze_checkpoint.py \
        ...
        --checkpoint artifacts/checkpoints/smacv2_epo_attn/seed0/final.pt \
        --episodes 64 --out artifacts/metrics/epo_attn_seed0.csv
...
# Make src/ importable (channel constraints + analysis estimators).
