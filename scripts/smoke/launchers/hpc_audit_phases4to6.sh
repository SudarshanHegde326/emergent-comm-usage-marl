...
run_smoke_gnn() {
    ...
    local ckpt_path="experiments/smacv2_gnncomm/seed${SMOKE_SEED}/final.pt"
    local log_file="/tmp/smoke_${label}.log"
...
run_smoke "09_nocomm"   "scripts/trainers/09_nocomm_mappo_smacv2.py"   "" \
    "experiments/smacv2_nocomm/seed${SMOKE_SEED}/final.pt"

run_smoke "10_fccomm"   "scripts/trainers/10_fccomm_mappo_smacv2.py"   "" \
    "experiments/smacv2_fccomm/seed${SMOKE_SEED}/final.pt"

run_smoke "11_attncomm" "scripts/trainers/11_attncomm_mappo_smacv2.py" "" \
    "experiments/smacv2_attncomm/seed${SMOKE_SEED}/final.pt"
